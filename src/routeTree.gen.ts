...
import { Route as AuthenticatedWatchIdNameImport } from "./routes/_authenticated.watch.$id.$name"
...
const AuthenticatedWatchIdNameRoute = AuthenticatedWatchIdNameImport.update({
  path: "/watch/$id/$name",
  getParentRoute: () => AuthenticatedRoute,
} as any)
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/_authenticated/watch/$id/$name": {
      ...
      preLoaderRoute: typeof AuthenticatedWatchIdNameImport
      parentRoute: typeof AuthenticatedImport
    }
  }
}
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/watch/$id/$name": {
      "filePath": "_authenticated.watch.$id.$name.tsx",
      "parent": "/_authenticated"
    }
  }
}
